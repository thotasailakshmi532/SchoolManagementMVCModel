...
using SchoolManagementMVCModel;

namespace SchoolManagementMVCModel.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RollNo,studentName,classId,subjectId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RollNo,studentName,classId,subjectId")] Student student)
        {
            if (ModelState.IsValid)
            {
